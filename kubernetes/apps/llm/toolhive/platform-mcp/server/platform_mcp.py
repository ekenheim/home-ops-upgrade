...
COMPUTE = {
    "quotas": "No ResourceQuota and no LimitRange exist in `datasci` or `llm`. Nothing is enforced; "
              "be a good citizen rather than relying on the platform to stop you.",
    "network_policies": "None in `datasci`, `llm` or `storage`. Cross-namespace traffic is open. "
...
PROBE_TARGETS = {
    ...
    "litellm": "http://litellm.llm.svc.cluster.local:4000/health/liveliness",
}
